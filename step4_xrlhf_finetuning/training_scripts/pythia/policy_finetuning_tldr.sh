...
DEV=0,1,2,3,4,5,6,7
PORT=1236
DATA_PATH="/efs/shicheng/remax/step3_rlhf_finetuning/pythia-2.8b_tldr_unsatisfactory.json"
ACTOR_MODEL_PATH=/efs/shicheng/remax/step3_rlhf_finetuning/output/pythia-2.8b/tldr/actor
REWARD_MODEL_PATH=/efs/shicheng/remax/step4_xrlhf_finetuning/output/pythia-2.8b/tldr/unlearned_reward
ACTOR_ZERO_STAGE=2
REWARD_ZERO_STAGE=3
...
if [ "$OUTPUT" == "" ]; then
    OUTPUT=./output/pythia-2.8b/tldr/policy
fi
