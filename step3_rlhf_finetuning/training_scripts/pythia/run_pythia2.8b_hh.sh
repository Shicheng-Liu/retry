...
ACTOR_MODEL_PATH=/efs/shicheng/remax/step1_supervised_finetuning/output/pythia-2.8b/full-hh-rlhf
REWARD_MODEL_PATH=/efs/shicheng/remax/step2_reward_model_finetuning/output/pythia-2.8b/full-hh-rlhf
ACTOR_ZERO_STAGE=2
REWARD_ZERO_STAGE=3
